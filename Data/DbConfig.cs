...
namespace ArmsFW.Data.Contexts
{
    public static class DbConfig
	{
		...
		public static string ConnectionString
        {
            get
            {
                //Caso nao esteja usando a configura��o do Tenant, busca da chave do appsettings.json no caminho : EFConfig:Conexao
        ...
        /// <summary>
        /// Determina as configura��o de conexao com o Contexto o EF de acordo com as o��es selecionadas no AppSettings.
...

        {
            ...
            try
            {
                ...
                {
                    App.GravarLog("EF - Falha ao carregar a string de Conex�o. A string esta vazia");
                }
            }
